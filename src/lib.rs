...
#[derive(Debug)]
pub struct FraxStableProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FraxStableProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FraxStable processing");
    
    let mut processor = FraxStableProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FraxStableProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FraxStableProcessor::new(false);
